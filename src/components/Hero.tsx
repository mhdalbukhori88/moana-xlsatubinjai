...
export default function Hero() {
  return (
    <section id="beranda" className="bg-[#002CBA] pt-24 pb-16 md:pt-32 md:pb-24 text-white">
      <div className="container-main px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          
          {/* Left Column: Clean Copywriting & Action Buttons */}
          <div className="lg:col-span-6 text-center lg:text-left">
            ...
            <div className="inline-flex flex-wrap items-center justify-center lg:justify-start gap-3 bg-white/10 rounded-2xl p-3 border border-white/20 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#cek-jangkauan"
                className="inline-flex items-center justify-center gap-2.5 rounded-full bg-white px-8 py-4 text-sm sm:text-base font-extrabold text-[#002CBA] shadow-xl hover:bg-slate-100 transition-colors"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 rounded-full bg-[#25D366] px-8 py-4 text-sm sm:text-base font-extrabold text-white shadow-xl hover:bg-[#20bd5a] transition-colors"
              >
          ...
          {/* Right Column: Clean Display of Campaign Image */}
          <div className="lg:col-span-6">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
              <Image
                src="/hero-bg.jpg"
                alt="XL SATU Udah Siap buat KASIH LEBIHHH"
                width={1200}
                height={675}
                priority
