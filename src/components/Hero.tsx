...
export default function Hero() {
  return (
    <section id="beranda" className="bg-[#002CBA] pt-24 pb-20 md:pt-32 md:pb-28 text-white">
      <div className="container-main px-4 sm:px-6 lg:px-8 text-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#cek-jangkauan"
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-8 py-4 text-base font-bold text-[#002CBA] shadow-md hover:bg-slate-100 transition-colors"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-8 py-4 text-base font-bold text-white shadow-md hover:bg-[#20bd5a] transition-colors"
          >
