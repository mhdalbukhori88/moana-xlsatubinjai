      ...
      <div className="container-main px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-primary/5 px-3 sm:px-4 py-1.5 sm:py-2">
            ...
            <span className="text-[10px] sm:text-xs font-semibold text-primary uppercase tracking-wider">Cek Jangkauan</span>
          </div>
          ...
          <p className="mb-6 sm:mb-10 text-sm sm:text-base text-text-muted sm:text-lg">
            Masukkan alamat atau kode pos untuk mengetahui apakah layanan XL SATU
            sudah tersedia di lokasi Anda
          </p>

          {/* Form card */}
          <div className="mx-auto max-w-2xl rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-6 shadow-xl md:p-10">
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 sm:pl-4">
                  <svg className="h-4 w-4 sm:h-5 sm:w-5 text-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input
                  ...
                  className="w-full rounded-xl sm:rounded-2xl border-2 border-gray-100 bg-surface py-3 sm:py-4 pl-10 sm:pl-12 pr-4 text-xs sm:text-sm text-text outline-none transition-all duration-300 placeholder:text-text-light focus:border-primary focus:ring-4 focus:ring-primary/10 md:text-base"
              ...
              <button
                ...
                className="btn-primary w-full py-3 sm:py-4 text-xs sm:text-base disabled:cursor-not-allowed disabled:opacity-50"
              >
                {status === "loading" ? (
            ...
            {/* Results */}
            {status === "available" && (
              <div className="mt-4 sm:mt-6 animate-fade-in-up rounded-xl sm:rounded-2xl border-2 border-green-200 bg-green-50 p-4 sm:p-6">
                <div className="flex flex-col items-center gap-3 sm:gap-4 text-center">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-bold text-green-800">🎉 Area Anda Terjangkau!</h3>
                  ...
                  <div className="flex flex-col gap-2 sm:gap-3 sm:flex-row w-full sm:w-auto">
                    ...
                    <button onClick={resetForm} className="btn-secondary text-xs sm:text-sm">
                      Cek Alamat Lain
                    </button>
                  </div>
                </div>
            ...
            {status === "unavailable" && (
              <div className="mt-4 sm:mt-6 animate-fade-in-up rounded-xl sm:rounded-2xl border-2 border-amber-200 bg-amber-50 p-4 sm:p-6">
                <div className="flex flex-col items-center gap-3 sm:gap-4 text-center">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-bold text-amber-800">Belum Tersedia</h3>
